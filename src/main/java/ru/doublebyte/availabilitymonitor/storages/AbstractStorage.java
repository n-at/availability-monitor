...
public abstract class AbstractStorage {
    ...
    protected synchronized <T> ConcurrentHashMap<Long, T> load(TypeReference<Map<Long, T>> typeReference) {
        if (fileName == null) {
        ...
        try {
            ...
            Map<Long, T> value = OBJECT_MAPPER.readValue(contents, typeReference);
    ...
    protected synchronized void save(Object value) {
        if (fileName == null) {
            throw new IllegalStateException("Storage file name is not defined");
        }
